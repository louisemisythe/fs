...
return [
    ...
    'checksum' => '70be5b9579faf1d8478127d14acb440d',
    'files' => [
        ...
        'user/plugins' => [
            ...
            'plugins/gdprprivacysetup' => [
                'file' => 'user/plugins/gdprprivacysetup/blueprints.yaml',
                'modified' => 1536292864
            ],
            'plugins/login' => [
    ...
    'data' => [
        'items' => [
            ...
            'plugins.gdprprivacysetup.enabled' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.gdprprivacysetup.enabled',
                'validation' => 'strict'
            ],
            'plugins.gdprprivacysetup.privacy_page_route' => [
                'type' => 'text',
                'label' => 'Url to site policy page',
                'name' => 'plugins.gdprprivacysetup.privacy_page_route',
                'validation' => 'strict'
            ],
            'plugins.gdprprivacysetup.modalWindowId' => [
                'type' => 'text',
                'label' => 'Modal popup content Id',
                'name' => 'plugins.gdprprivacysetup.modalWindowId',
                'validation' => 'strict'
            ],
            'plugins.gdprprivacysetup.denyRedirectionTarget' => [
                'type' => 'text',
                'label' => 'Deny consent redirect url',
                'name' => 'plugins.gdprprivacysetup.denyRedirectionTarget',
                'validation' => 'strict'
            ],
            'plugins.gdprprivacysetup.inputPrefix' => [
                'type' => 'text',
                'label' => 'Input prefix',
                'name' => 'plugins.gdprprivacysetup.inputPrefix',
                'validation' => 'strict'
            ],
            'plugins.gdprprivacysetup.privacySettingsBtnClass' => [
                'type' => 'text',
                'label' => 'Button Class to open popup',
                'name' => 'plugins.gdprprivacysetup.privacySettingsBtnClass',
                'validation' => 'strict'
            ],
            'plugins.gdprprivacysetup.deferInfoPopupTime' => [
                'type' => 'text',
                ...
                'name' => 'plugins.gdprprivacysetup.deferInfoPopupTime',
                'validation' => 'strict'
            ],
            'plugins.gdprprivacysetup.consentExpiresTime' => [
                'type' => 'text',
                ...
                'name' => 'plugins.gdprprivacysetup.consentExpiresTime',
                'validation' => 'strict'
            ],
            'plugins.gdprprivacysetup.pluginTab' => [
                'type' => 'tab',
                'name' => 'plugins.gdprprivacysetup.pluginTab',
                'validation' => 'strict'
            ],
            'plugins.gdprprivacysetup.consentButtonText' => [
                'type' => 'text',
                'label' => 'Button Text for privacy setup consent',
                'name' => 'plugins.gdprprivacysetup.consentButtonText',
                'validation' => 'strict'
            ],
            'plugins.gdprprivacysetup.consentButtonClass' => [
                'type' => 'text',
                'label' => 'Consent button class',
                'name' => 'plugins.gdprprivacysetup.consentButtonClass',
                'validation' => 'strict'
            ],
            'plugins.gdprprivacysetup.denyButtonText' => [
                'type' => 'text',
                'label' => 'Button Text for deny any consent',
                'name' => 'plugins.gdprprivacysetup.denyButtonText',
                'validation' => 'strict'
            ],
            'plugins.gdprprivacysetup.denyButtonClass' => [
                'type' => 'text',
                'label' => 'Deny button class',
                'name' => 'plugins.gdprprivacysetup.denyButtonClass',
                'validation' => 'strict'
            ],
            'plugins.gdprprivacysetup.privacyInfo' => [
                'type' => 'editor',
                'label' => 'Privacy Information',
                'name' => 'plugins.gdprprivacysetup.privacyInfo',
                'validation' => 'strict'
            ],
            'plugins.gdprprivacysetup.contentTab' => [
                'type' => 'tab',
                'name' => 'plugins.gdprprivacysetup.contentTab',
                'validation' => 'strict'
            ],
            'plugins.gdprprivacysetup.consentPolicyList' => [
                'type' => 'list',
                'label' => 'Consents and Content Seciurity Policy',
                'name' => 'plugins.gdprprivacysetup.consentPolicyList',
                'validation' => 'strict'
            ],
            'plugins.gdprprivacysetup.consentPolicyList.consent' => [
                'type' => 'text',
                'label' => 'Consent Name',
                'required' => true,
                'name' => 'plugins.gdprprivacysetup.consentPolicyList.consent',
                'validation' => 'strict'
            ],
            'plugins.gdprprivacysetup.consentPolicyList.policy' => [
                'type' => 'text',
                'label' => '(Optional) Url or CSP value',
                'name' => 'plugins.gdprprivacysetup.consentPolicyList.policy',
                'validation' => 'strict'
            ],
            'plugins.gdprprivacysetup.consentPolicyList.default' => [
                'type' => 'toggle',
                ...
                'name' => 'plugins.gdprprivacysetup.consentPolicyList.default',
                'validation' => 'strict'
            ],
            'plugins.gdprprivacysetup.cspTab' => [
                'type' => 'tab',
                'name' => 'plugins.gdprprivacysetup.cspTab',
                'validation' => 'strict'
            ],
            'plugins.gdprprivacysetup.whitelistPages' => [
                'type' => 'pages',
                ...
                'name' => 'plugins.gdprprivacysetup.whitelistPages',
                'validation' => 'strict'
            ],
            'plugins.gdprprivacysetup.whitelistTab' => [
                'type' => 'tab',
                'name' => 'plugins.gdprprivacysetup.whitelistTab',
                'validation' => 'strict'
            ],
            'plugins.gdprprivacysetup.tabs' => [
                'type' => 'tabs',
                'active' => 1,
                'name' => 'plugins.gdprprivacysetup.tabs',
                'validation' => 'strict'
            ],
            'plugins.login' => [
                'type' => '_root',
        ...
        'nested' => [
            ...
            'plugins' => [
                ...
                'gdprprivacysetup' => [
                    'tabs' => 'plugins.gdprprivacysetup.tabs',
                    'pluginTab' => 'plugins.gdprprivacysetup.pluginTab',
                    'enabled' => 'plugins.gdprprivacysetup.enabled',
                    'privacy_page_route' => 'plugins.gdprprivacysetup.privacy_page_route',
                    'modalWindowId' => 'plugins.gdprprivacysetup.modalWindowId',
                    'denyRedirectionTarget' => 'plugins.gdprprivacysetup.denyRedirectionTarget',
                    'inputPrefix' => 'plugins.gdprprivacysetup.inputPrefix',
                    'privacySettingsBtnClass' => 'plugins.gdprprivacysetup.privacySettingsBtnClass',
                    'deferInfoPopupTime' => 'plugins.gdprprivacysetup.deferInfoPopupTime',
                    'consentExpiresTime' => 'plugins.gdprprivacysetup.consentExpiresTime',
                    'contentTab' => 'plugins.gdprprivacysetup.contentTab',
                    'consentButtonText' => 'plugins.gdprprivacysetup.consentButtonText',
                    'consentButtonClass' => 'plugins.gdprprivacysetup.consentButtonClass',
                    'denyButtonText' => 'plugins.gdprprivacysetup.denyButtonText',
                    'denyButtonClass' => 'plugins.gdprprivacysetup.denyButtonClass',
                    'privacyInfo' => 'plugins.gdprprivacysetup.privacyInfo',
                    'cspTab' => 'plugins.gdprprivacysetup.cspTab',
                    'consentPolicyList' => [
                        'consent' => 'plugins.gdprprivacysetup.consentPolicyList.consent',
                        'policy' => 'plugins.gdprprivacysetup.consentPolicyList.policy',
                        'default' => 'plugins.gdprprivacysetup.consentPolicyList.default'
                    ],
                    'whitelistTab' => 'plugins.gdprprivacysetup.whitelistTab',
                    'whitelistPages' => 'plugins.gdprprivacysetup.whitelistPages'
                ],
                'login' => [
